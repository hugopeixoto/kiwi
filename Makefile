...
SRCS=helpers/core.cc routing/base.cc application/base.cc controller/base.cc controller/engine.cc view/base.cc view/parameters.cc model/attribute.cc $(HTTP_SRCS)
